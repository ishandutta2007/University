...
{
	// cout << fabs(ang(b-a, c-a)) << "    " << endl;
	// cout << fabs(ang(c-b, a-b)) << "    " << endl;
	Line l1 = Line(a, Rotate(b-a, fabs(Angle(b-a, c-a)))), l2 = Line(b, Rotate(c-b, fabs(Angle(c-b, a-b)))), l3 = Line(a, c - a);
	cout << l1.v.x <<","<< l1.v.y<<endl;
	cout << l2.v.x <<","<< l2.v.y<<endl;
	Point o = GetlineIntersection(l1, l2);
	printf("(%.6lf,%.6lf,%.6lf)\n", o.x,o.y,DistanceToLine(o, l3));
}
